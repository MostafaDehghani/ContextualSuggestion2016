...
public class CalculateGLM {
    ...
    public static void main(String[] args) throws IOException {
        ...
        ArrayList<Integer> docsList = iInfo.getDocsContainingTerm("GROUP", "Family");
...
//        System.out.println("PLM:" + dGroup.getGroupParsimoniouseLM().getSize());
        System.out.println("GLM" + dGroup.getGroupSWLM().getTopK(20));   
        System.out.println("GLM:" + dGroup.getGroupSWLM().getSize());   
//        System.out.println("HGLM" + dGroup.getGroupHSWLM().getTopK(20));   
